...
//Heizelmannconst uint8_t MAX_DS3502 = 4;               // Max number of DS3502 digitsal potentiometer devices
const uint8_t MAX_DS3502 = 2;               // Max number of DS3502 digitsal potentiometer devices
